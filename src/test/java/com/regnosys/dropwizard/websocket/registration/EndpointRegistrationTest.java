...
import com.regnosys.dropwizard.websocket.registration.endpointtypes.EndpointType;
...
public class EndpointRegistrationTest {
    ...
    public void addingAnnotatedEndpointCorrectlyRegistersIt() {
        ...
        for (com.regnosys.dropwizard.websocket.registration.Endpoint endpoint : endpoints) {
